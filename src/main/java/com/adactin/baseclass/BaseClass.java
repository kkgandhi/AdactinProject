...
public class BaseClass {
	  ...
	  public static  WebDriver  getBrowser(String browserName) throws Exception {
		       try {
				if(browserName.equalsIgnoreCase("chrome")){
					   System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"\\src\\test\\resource\\com\\adactin\\drivers\\chromedriver.exe");
	...
	public static String getValueOfAtrribute(WebElement element) {
          try {
			waitForElementVisibility(element);
			  String valueOfAtrribute = element.getAttribute("value");
			return valueOfAtrribute;
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException();
		}
